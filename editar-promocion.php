...
include('header.php'); ?>
	<div id="contenido">
		...
		<div class="registros" style="width: 50%">
			...
			<p class="tac"><a href="inicio-de-operaciones.php?id_marca=<?php echo $_GET['id_marca']; ?>&id_lead=id_lead<?php  ?>" class="btn btn-success" onclick="return confirm('¿Seguro que desea iniciar operacones?');">INICIO DE OPERACIONES</a></p>
		</div>
