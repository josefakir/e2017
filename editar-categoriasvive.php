...
include('header.php'); ?>
	<div id="contenido">
		...
		<?php 
			$ch = curl_init(); 
			curl_setopt($ch, CURLOPT_URL, URL_API."categoriasvive/".$_GET['id']); 
			curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
			$output = json_decode(curl_exec($ch)); 
			curl_close($ch); 
		?>
			<form class='validation-form'  action="api/update/categoriasvive" method="post" enctype="multipart/form-data">
